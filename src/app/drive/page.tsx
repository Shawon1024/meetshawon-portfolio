            ...
            <div className="grid items-center gap-12 lg:grid-cols-[1.15fr_0.85fr]">
              ...
              <div>
                ...
                <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-400">
                  A private storage environment designed for secure
                  file access, personal data management, and controlled
                  sharing through MeetShawon.Com.
                </p>
                ...
                <div className="mt-10 grid gap-4 sm:grid-cols-3">
                  <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-500">
                      Access-controlled personal storage.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-500">
                      Built around authenticated access.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-500">
                      Future storage hosted on private infrastructure.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <p className="mt-4 leading-7 text-gray-400">
                  Secure cloud access is being prepared. Once the private
                  storage server is connected, authorised users will be able
                  to access their files here.
                </p>
                ...
                <div className="mt-8 rounded-2xl border border-white/10 bg-black/10 p-5">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-6 text-gray-500">
                        The interface is live, but private storage services
                ...
                <p className="mt-4 text-center text-xs leading-6 text-gray-600">
                  Access will be available to authorised users only.
                </p>
              </div>
